...
def conv_batchnorm_relu_pool_forward(x,w,b,gamma,beta,
  ...
  a, conv_cache = conv_forward_fast(x, w, b, conv_param)
  aa, bn_cache = spatial_batchnorm_forward(a, gamma, beta, bn_param) 
...
def conv_batchnorm_relu_pool_backward(dout, cache):
  ...
  da, dgamma, dbeta = spatial_batchnorm_backward(daa, bn_cache) 
  dx, dw, db = conv_backward_fast(da, conv_cache)
...
def affine_batchnorm_relu_backward(dout, cache):
  ...
  da, dgamma, dbeta = batchnorm_backward_alt(daa, bn_cache)
  dx, dw, db = affine_backward(da, fc_cache)
  return dx, dw, db, dgamma, dbeta

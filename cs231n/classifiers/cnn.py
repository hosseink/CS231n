...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
               hidden_dim=100, num_classes=10, dropout=0, use_batchnorm = False,
  ...
  def loss(self, X, y=None):
    ...
    if self.use_batchnorm:
      ...
      out, cache1 = conv_batchnorm_relu_pool_forward(X, 
						W1, b1, gamma1, beta1, conv_param, self.bn_param1, pool_param)
      out, cache2 = affine_batchnorm_relu_forward(out, W2, b2, 
												gamma2, beta2, self.bn_param2)
    ...
    if self.use_batchnorm:
      dout1, dW2, db2, dgamma2, dbeta2= affine_batchnorm_relu_backward(dout2, cache2)
      dx, dW1, db1, dgamma1, dbeta1 = conv_batchnorm_relu_pool_backward(dout1, cache1)
    else:
